...
Let's first have a look at how the humanized animal model fecal bacterial communities cluster relative to the human donor inocula communities. As mentioned earluer, we'll compare only the 'late inoculation' piglets to the mice and human donor samples:
...
##**Comparing unifrac and Bray-Curtis distances**##
...
library('bayesbio'); packageVersion('bayesbio')

# INF2 donor
jaccardSets(core_INF2_taxa,core_INF2_taxa_colonizing_mice) # 0.81
jaccardSets(core_INF2_taxa,core_INF2_taxa_colonizing_piglets) # 0.77

# CHLD2 donor
jaccardSets(core_CHLD2_taxa,core_CHLD2_taxa_colonizing_mice) # 0.49
jaccardSets(core_CHLD2_taxa,core_CHLD2_taxa_colonizing_piglets) # 0.86

# ADLT2 donor
jaccardSets(core_ADLT2_taxa,core_ADLT2_taxa_colonizing_mice) # 0.47
jaccardSets(core_ADLT2_taxa,core_ADLT2_taxa_colonizing_piglets) # 0.76

# ELD2 donor
jaccardSets(core_ELD2_taxa,core_ELD2_taxa_colonizing_mice) # 0.41
jaccardSets(core_ELD2_taxa,core_ELD2_taxa_colonizing_piglets) # 0.69
```
...
unwunifrac_INF_supp_core <- plot_ordination(supp_mater_INF_core_ps.prop, unw_ord_INF_core, color = "Species", shape = "Species") + ggtitle("Infant donor core PCoA plot - unweighted unifrac") + theme(plot.title = element_text(hjust = 0.5)) + labs(colour = " ", shape = "host species")
